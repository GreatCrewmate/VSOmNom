	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				...
				animation.addByPrefix('pogrtalf', 'GF portal', 24, false);

				addOffset('pogrtalf', 60, 75);
			...
			case 'bf':
				...
				animation.addByPrefix('unconsin', 'BF hit', 24, false);
				animation.addByPrefix('portalbf', 'BF portal', 24, false);

				addOffset('portalbf', 80, 240);
			...
			case 'omnom':
				playerColor = "97D300";
				frames = Paths.getSparrowAtlas('om_nom','shared',true);
				animation.addByPrefix('idle', 'Om Nom idle', 24, false);
				animation.addByPrefix('singUP', 'Om Nom Up Note', 24, false);
				animation.addByPrefix('singDOWN', 'Om Nom Down Note', 24, false);
				animation.addByPrefix('singLEFT', 'Om Nom Left Note', 24, false);
				animation.addByPrefix('singRIGHT', 'Om Nom Right Note', 24, false);

				addOffset('idle', 0, -320);
				addOffset('singUP', 0, -295);
				addOffset('singDOWN', 0, -290);
				addOffset('singLEFT', 0, -292);
				addOffset('singRIGHT', 0, -300);

			case 'omnomangry':
				playerColor = "97D300";
				frames = Paths.getSparrowAtlas('om_nom_angry','shared',true);
				animation.addByPrefix('idle', 'Om Nom idle', 24, false);
				animation.addByPrefix('singUP', 'Om Nom Up Note', 24, false);
				animation.addByPrefix('singDOWN', 'Om Nom Down Note', 24, false);
				animation.addByPrefix('singLEFT', 'Om Nom Left Note', 24, false);
			...
			case 'omnomsup':
				playerColor = "D80E1E";
				frames = Paths.getSparrowAtlas('om_nom_sup','shared',true);
				animation.addByPrefix('idle', 'Om Nom idle', 24, false);
				animation.addByPrefix('singUP', 'Om Nom Up Note', 24, false);
				animation.addByPrefix('singDOWN', 'Om Nom Down Note', 24, false);
				animation.addByPrefix('singLEFT', 'Om Nom Left Note', 24, false);
				...
				addOffset('singUP', 0, -225);
				addOffset('singDOWN', 0, -235);
				addOffset('singLEFT', 0, -240);
				addOffset('singRIGHT', 0, -225);

			case 'omnomstanding':
				playerColor = "97D300";
				var tex = Paths.getSparrowAtlas('om_nom_stand','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'ON idle', 24, false);
				animation.addByPrefix('singUP', 'ON Note Up', 24, false);
				animation.addByPrefix('singDOWN', 'ON Note Down', 24, false);
				animation.addByPrefix('singLEFT', 'ON Note Left', 24, false);
				animation.addByPrefix('singRIGHT', 'ON Note Right', 24, false);

				addOffset('idle', 0, -240);
				addOffset('singUP', 0, -220);
				addOffset('singDOWN', 0, -210);
				addOffset('singLEFT', 10, -210);
				addOffset('singRIGHT', -10, -208);
